 ...
 * halterbild.php
 *
 * Liefert das Foto eines Halters direkt aus der Datenbank (BLOB) aus.
 * Analog zu hundebild.php. Portal-Prinzip: nur Ersteller oder Admin
 * dürfen das Foto sehen (Halter::findImageByIdForUser() erzwingt das
 * Scoping).
 */
...
$image    = $halterId ? Halter::findImageByIdForUser($halterId, $currentUserId, $isAdmin) : null;
